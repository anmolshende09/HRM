...
const NAV_ITEMS = [
  ...
  { to: "/branches", label: "Branches", icon: MapPin, managerOnly: true },
  { to: "/departments", label: "Departments", icon: Building2, managerOnly: true },
  { to: "/designations", label: "Designations", icon: IdCard, managerOnly: true },
  { to: "/award-types", label: "Award Types", icon: Award, managerOnly: true },
  { to: "/document-types", label: "Document Types", icon: FileCheck2, managerOnly: true },
  { to: "/holidays", label: "Holidays", icon: Palmtree, managerOnly: true },
